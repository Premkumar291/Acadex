...
const FacultyManagement = () => {
  ...
  const [activeItem, setActiveItem] = useState(() => {
    ...
    return savedItem || "Faculty Management"
  })
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: isDarkMode ? "#000000" : "#F9FAFB" }}>
      ...
      >
        <span style={{ fontSize: "20px", color: isDarkMode ? "#ffffff" : "#000000" }}>☰</span>
      </button>
                  ...
                  <div style={{ padding: "40px" }}>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div style={{ marginBottom: "40px" }}>
                        ...
                        {/* Add Study Form */}
                        <div
                          style={{ background: "#f8f9fa", padding: "24px", borderRadius: "16px", marginBottom: "24px" }}
                        >
                          <div
                            style={{
                              display: "grid",
